...
export const CodeBlockHeader = ({
  ...
  <div
    className={cn(
      "flex flex-row dark:!bg-gray-900 items-center border-b bg-secondary !p-2 !pl-3 ",
      className
    )}
    {...props}
  />
...
export const CodeBlockFilename = ({
  ...
  return (
    <div
      className="flex items-center gap-2 !bg-transparent px-4 py-1.5 text-muted-foreground text-xs"
      {...props}
    >
...
export const CodeBlockSelectTrigger = ({
  ...
  <SelectTrigger
    className={cn(
      "w-fit border-none text-muted-foreground text-xs shadow-none !bg-olive-900 !pl-2 !pr-2",
      className
    )}
    {...props}
  />
...
export const CodeBlockSelectItem = ({
  ...
  <SelectItem className={cn("text-sm !p-1", className)} {...props} />
);
